...
class PolicyGuardTest {
    ...
    private fun denied(result: PolicyEvaluationResult): PolicyEvaluationResult.Denied = assertIs<PolicyEvaluationResult.Denied>(result)
