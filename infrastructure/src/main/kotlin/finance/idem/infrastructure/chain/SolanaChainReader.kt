...
class SolanaChainReader(
    ...
    override fun poll(checkpoint: Long): List<DetectedTransfer> {
        ...
        val signaturesByAddress =
            watched.associateWith { watchedAddress ->
    ...
    internal fun decodeTransfer(
        ...
        val postAmount =
            receiving.uiTokenAmount.amount.toLongOrNull() ?: run {
    ...
    private fun getSignaturesForAddress(
        address: String,
        checkpoint: Long,
    ...
    private fun fetchSignaturePage(
        address: String,
        limit: Int,
        before: String?,
    ): List<SolanaSignatureInfo> {
    ...
    internal data class SolanaSignaturesResponse(
